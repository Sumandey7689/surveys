...
<form name="userForm" id="userForm" enctype="multipart/form-data">
    ...
    <div class="row">       
        ...
        <input type="hidden" name="user_id" id="user_id" value="@if($mode == "Edit" && !empty($usereditData)){{ $id }}@endif">
        <input type="hidden" name="mode" id="mode" value="{{ $mode }}">

        <x-image-component column="col-md-3" label="Image Size (200 X 200)" name="imagefile" id="imagefile"
                    class="" imagePreview="imagePreview" value="{{getEditData($mode,$usereditData,'profile_image',asset('storage/users'))}}" />        
        <div class="col-md-9">
            <div class="row">
                ...
                <x-input-component column="col-md-5" type="text" label="Mobile No" name="mobile_no" id="mobile_no"
                    class="onlynumber" placeholder="Enter mobile no" value="{{getEditData($mode,$usereditData,'mobile_no')}}" />
                ...
                <x-select-component :data="$roleList" arraykey="id" arrayValue="role" column="col-md-5"
                    label="Role" name="role_id" id="role_id" class="" placeholder=""
        ...
        <x-input-component column="col-md-6" type="password" label="Confirm Password" name="confirm_password" id="confirm_password" class="" placeholder="Enter confirm password" value="" />
        @endif    
    </div>
